...
//#define CST_URL @"http://mtvnmobile.mtvnservices.com/cst/5/"
...
- (void) updateInterfaceWithReachability: (Reachability*) curReach{
    ...
    urlAddress = [NSString stringWithFormat:@"%@readquerystring.html?mgid=%@&platform=%@&appname=%@&wrapperversion=%@&params=%@", CST_URL, self.mGid, self.platform, self.appName,WRAPPER_VERSION,[params stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
